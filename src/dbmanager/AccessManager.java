...
public class AccessManager{
	...
	*****************************************************************/
	public AccessManager( String i_FileName )
	{
		...
		System.out.println(m_ConnectStr);
	 ...
	 *****************************************************************/
	public ArrayList<HashMap<String,String>> select(String i_SQL ,String[] i_Columns )
	{
		ResultSet rs = null ;
	...
	/******************************************************************
	 * insertのｓql文を実行する時に使用する
	 * @param i_SQL ,		//実行したいsql文
	 * @return 成功 true , 失敗 false
	 *****************************************************************/
	public boolean insert(String i_SQL) {
		try{
